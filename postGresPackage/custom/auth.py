...
SECRET_KEY = "bad7a4e476dd5736a139951e856689acdb80f485f80b5533667bd9aea342981d"
ALGORITHM = "HS256"
...
async def login_for_access_token(form_data: Annotated[OAuth2PasswordRequestForm, Depends()], db: db_dependency):
    ...
    return {"access_token": token, "token_type": "bearer", "expire": 3600}
...
async def get_current_user(token: Annotated[str, Depends(oauth2_bearer)]):
    try:
        ...
        raise HTTPException(
            ...
            detail=f"Could not validate user, Exception occurred: {err}"
        )
